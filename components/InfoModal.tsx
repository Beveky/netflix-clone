...
const InfoModal: React.FC<InfoModalProps> = ({ visible, onClose }) => {
  ...
  const isLocalVideo = data?.videoUrl?.startsWith('http://commondatastorage');
  return (
      ...
      <div className="relative w-auto mx-auto max-w-3xl rounded-md overflow-hidden">
        <div className={`${isVisible ? 'scale-100' : 'scale-0'} transform duration-300 relative flex-auto bg-zinc-900 drop-shadow-md`}>
          ...
          {isLocalVideo ? (
              ...
              <iframe src={`${data?.videoUrl}?autoplay=1&mute=1&loop=1`} frameBorder="0" allowFullScreen className="w-full brightness-[60%] object-cover h-full"></iframe>
